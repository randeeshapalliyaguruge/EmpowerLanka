    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                <svg class="w-40 m-auto opacity-75" viewBox="0 0 146 146" fill="none"
                    ...
                    <path
                        ...
                        stroke="url(#paint0_linear_622:13617)" stroke-width="10"
                    ...
                    <path
                        ...
                        stroke="url(#paint1_linear_622:13617)" stroke-width="10"
                        stroke-linecap="round" />
                    <path
                    ...
                    <path d="M73 5.00001C86.6504 5.00001 99.9849 9.10831 111.269 16.7904"
                        ...
                        stroke-linecap="round" />
                    <circle cx="73.5" cy="72.5" r="29" fill="#e4e4f2"
                        stroke="#e4e4f2" />
                    <path
        ...
        <div>
            <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                ...
                <svg class="w-full" viewBox="0 0 218 69" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
