                    ...
                    <div class="w-full max-w-lg">
                        <form method="POST" action="{{ route('send-email') }}" enctype="multipart/form-data">
                            ...
                            <div class="md:flex md:items-center">
                                <div class="md:w-1/3">
                                    @guest
                                        <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900" style="white-space: nowrap;">
                                            Log in to Send
