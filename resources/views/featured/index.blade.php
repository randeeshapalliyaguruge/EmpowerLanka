<x-app-layout>
    <div class="py-8">
        ...
        <div class="flex justify-center items-center mt-8">
            <div class="w-full bg-white rounded-lg pl-10 pr-10 pt-10 pb-2">
                <div class="flex justify-center m-2 ">
                    <h2 class="font-semibold text-2xl text-gray-800 leading-tight pb-10">
                        Feautured Ads
                    </h2>
                </div>
